(function () {
    ...
    callWithJQuery = function (pivotModule) {
      if (typeof exports === "object" && typeof module === "object") {
        ...
        return define(["jquery", "../thirdpartylibs/plotly.js"], pivotModule);
      } else {
    ...
    callWithJQuery(function ($, Plotly) {
      ...
      makePlotlyChart = function (traceOptions, layoutOptions, transpose) {
        ...
        return function (pivotData, opts) {
          ...
          if (opts.cr0) {
            if (opts.cr0.size.height) {
              layout.height = opts.cr0.size.height;
            }
            if (opts.cr0.size.width) {
              layout.width = opts.cr0.size.width;
            }
          }
