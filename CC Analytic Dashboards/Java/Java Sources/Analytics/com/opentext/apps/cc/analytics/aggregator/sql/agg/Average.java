...
public class Average extends AbstractAggregatorStat {

	public Average(DBType dbType) {
		super(dbType);
	}
	...
	public String buildQuery(AbstractQueryBuilder queryBuilder, String workList) {
		...
		if (Objects.isNull(queryBuilder.getJoinQuery())) {
			return "select  " + queryBuilder.getxColumnName() + " as xcol," + prepareYCol(queryBuilder) + " avg(  "
