...
public class Maximum extends AbstractAggregatorStat {

	public Maximum(DBType dbType) {
		super(dbType);
	}
	...
	public String buildQuery(AbstractQueryBuilder queryBuilder, String workList) {
		...
		if (Objects.isNull(queryBuilder.getJoinQuery())) {
			return "select  " + queryBuilder.getxColumnName() + " as xcol," + prepareYCol(queryBuilder) + " max(   "
