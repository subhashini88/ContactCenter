package com.opentext.apps.cc.custom.exceptions;
...
public class ContractCenterAlertMessages {
	...
	public static final Message RESTSERVICE_FAILURE_CREATE_NODE = CC_MESSAGE_SET.getMessage("errorCreateNodeinCS");
}
