...
import com.opentext.apps.cc.importhandler.tasklist.ImportConstants;
import com.opentext.apps.cc.importhandler.tasklist.ImportConstants.AssignmentType;
import com.opentext.apps.cc.importhandler.tasklist.ImportConstants.TransitState;
	...
	private void createRequest(Map<String, String> row) {
		...
		if (taskType.equalsIgnoreCase(TypeOfActivity.STANDARD.getValue())
			...
			Node.setDataElement(activityNode, ImportConstants.RELATED_GC_PROCESS_REQ,
					metadata.processMap.get(ImportConstants.PROCESS_NAME));
			}
		}
