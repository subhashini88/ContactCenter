...
public class ContractCenterAlertMessages {
	...
	public static final Message ERROR_WHILE_INVOKING_DATA_IMPORT = CC_MESSAGE_SET.getMessage("errorWhileInvokingDataImport");
	public static final Message ROLE_NOT_FOUND = CC_MESSAGE_SET.getMessage("roleNotFound");
